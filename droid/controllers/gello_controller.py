...
class GELLOPolicy:
    ...
    def on_press(self, key):
        try:
            if key.char == "1":
                self._state["buttons"]["B"] = True
            elif key.char == "2":
                self._state["buttons"]["A"] = True
    ...
    def _update_internal_state(self, num_wait_sec=5, hz=50):
        ...
        while True:
            ...
            joint_states = self.gello_agent.act({})
            ...
            # Save Info #
            self._state["joint_states"] = joint_states
    ...
    def forward(self, obs_dict, include_info=False):
        # print(self._state)
        return self._state["joint_states"], None
